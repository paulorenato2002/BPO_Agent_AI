...
-- endpoint OpenAPI do PostgREST em 2026-09-01T19:11:43.311Z.
--
...
create table if not exists public.contrato_servicos (
  ...
  prazo_entrega_dias_uteis smallint,
...
create table if not exists public.tarefas_modelo_onboarding (
  ...
  prazo_dias_apos_inicio_fase smallint default 0 not null,
  duracao_estimada_minutos smallint,
...
create table if not exists public.modelo_recursos_equipe (
  ...
  cargo_funcao text,
  quantidade_pessoas smallint default 1 not null,
...
create table if not exists public.precificacao_componentes (
  ...
  meses_rateio smallint default 1 not null,
